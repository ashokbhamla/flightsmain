...
export function generateCleanContent(context: CleanContentContext): CleanContent {
  ...
  return translateCleanContent(masterContent, locale, context);
}
...
function generateEnglishMasterContent(context: CleanContentContext): CleanContent {
  ...
  // SINGLE UI elements - no duplicates
  const ui = {
  ...
  // SINGLE SEO content - no duplicates
  const seo = {
...
/**
 * Translate clean content to target language
 * Maintains NO DUPLICATES across all languages
 */
function translateCleanContent(masterContent: CleanContent, locale: Locale, context: CleanContentContext): CleanContent {
  const { airlineName, departureCity, arrivalCity } = context;
  
  // Get translation object for target language
  const t = getTranslations(locale);
  
  // Translate title and description (NO DUPLICATES)
  ...
  // Translate content sections (NO DUPLICATES)
...
/**
 * Translate title based on locale (NO DUPLICATES)
 */
...
/**
 * Translate description based on locale (NO DUPLICATES)
 */
...
/**
 * Translate HTML content based on locale (NO DUPLICATES)
 */
function translateHtmlContent(content: string, locale: Locale, t: any, contentType: string): string {
  ...
  // Translate the title (NO DUPLICATES)
  ...
  // Translate the body content (NO DUPLICATES)
...
/**
 * Translate content body based on locale (NO DUPLICATES)
 */
function translateContentBody(body: string, locale: Locale, t: any): string {
  if (locale === 'en') return body;
  
  // Return English content as structure is the same
  return body;
}

/**
 * Translate FAQs based on locale (NO DUPLICATES)
 */
function translateFAQs(faqs: Array<{ q: string; a: string }>, locale: Locale, t: any, airlineName: string, departureCity: string, arrivalCity?: string): Array<{ q: string; a: string }> {
  ...
  // Get translated FAQs from translation system (NO DUPLICATES)
...
/**
 * Get translated FAQs for specific locale (NO DUPLICATES)
 */
...
/**
 * Translate UI elements based on locale (NO DUPLICATES)
 */
