          ...
          <Box sx={{ 
            ...
            <Box sx={{ maxWidth: 900 }}>
              <Typography variant="caption" sx={{ color: '#9aa0a6', display: 'block', textAlign: { xs: 'center', sm: 'left' }, mb: 1.5 }}>
                <strong>Disclaimer & TCPA Consent</strong> — By providing your phone number, you consent to receive calls and text messages (including automated or pre-recorded messages) from AirlinesMap.com, its affiliates, and partners at the number provided. Message and data rates may apply. You can opt out anytime by replying &quot;STOP&quot; or calling (888) 351-1711.
              </Typography>
