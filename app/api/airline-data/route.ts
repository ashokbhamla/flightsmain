...
export async function GET(request: NextRequest) {
  try {
    ...
    const apiUrl = `${process.env.NEXT_PUBLIC_API_REAL}/real/airlines?airline_code=${airline_code}&arrival_iata=${arrival_iata}&departure_iata=${departure_iata}&lang_id=${lang}&domain_id=${domain_id}`;
    ...
    console.error('Error in airline-data API route:', error);
